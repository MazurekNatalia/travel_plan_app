...
class CostEstimatesPage extends StatefulWidget{
  @override
  _CostEstimatesState createState() => new _CostEstimatesState();
}

class _CostEstimatesState extends State<CostEstimatesPage> {
  @override
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(
          title: new Text('Cost Estimates',
              style: new TextStyle(
                  fontSize: 25.0,
